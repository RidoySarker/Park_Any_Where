                                    ...
                                    <div class="form-group" id="package_name">
                                        ...
                                        <select class="form-control" name="package_name">
                                            ...
                                            @foreach($package_data as $package_value)
                                                <option
                                                    value="{{$package_value->package_id}}" {{$package_value->package_id==$edit_data->package_name ? "selected" : ''}}>{{$package_value->package_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" id="vehicle_type">
                                        ...
                                        <select class="form-control" name="vehicle_type">
                                            ...
                                            @foreach($vehicle_data as $vehicle_value)
                                                <option
                                                    value="{{$vehicle_value->vehicle_id}}" {{$vehicle_value->vehicle_id==$edit_data->vehicle_type ? "selected" : ''}}>{{$vehicle_value->vehicle_type}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <!-- Package Data -->
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6" id="parking_charge">
                                            ...
                                            <div class="input-group">
                                                <input
                                                    value="{{$edit_data->vehicleType ? $edit_data->vehicleType->vehicle_charge : $edit_data->PackageVehicle->package_charge}}"
                                                    id="data_parking_charge" name="parking_charge" type="number"
                                                    class="form-control" placeholder="Charge" readonly>
                                        ...
                                        <div class="form-group col-md-3" id="parking_time">
                                            ...
                                            <div class="input-group">
                                                <input
                                                    value="{{$edit_data->vehicleType ? $edit_data->vehicleType->vehicle_time : $edit_data->PackageVehicle->package_time}}"
                                                    id="data_parking_time" name="parking_time" type="number"
                                                    class="form-control" placeholder="Time" readonly="">
                                        ...
                                        <div class="form-group col-md-3" id="parking_period">
                                            <label for="inputState" class="col-form-label">Period</label>
                                            <select id="data_parking_period" name="parking_period" class="form-control"
                                                    disabled>
                                                <option selected disabled hidden>Choose</option>
                                                @if($edit_data->vehicleType)
                                                    <option
                                                        value="minute" {{$edit_data->vehicleType->vehicle_period=="minute" ? "selected" : ''}}>
                                                        Minute (s)
                                                    </option>
                                                    <option
                                                        value="hour" {{$edit_data->vehicleType->vehicle_period=="hour" ? "selected" : ''}}>
                                                        Hour (s)
                                                    </option>
                                                    <option
                                                        value="day" {{$edit_data->vehicleType->vehicle_period=="day" ? "selected" : ''}}>
                                                        Day (s)
                                                    </option>
                                                    <option
                                                        value="week" {{$edit_data->vehicleType->vehicle_period=="week" ? "selected" : ''}}>
                                                        Week (s)
                                                    </option>
                                                    <option
                                                        value="month" {{$edit_data->parking_period=="month" ? "selected" : ''}}>
                                                        Month (s)
                                                    </option>
                                                    <option
                                                        value="year" {{$edit_data->vehicleType->vehicle_period=="year" ? "selected" : ''}}>
                                                        Year (s)
                                                    </option>
                                                @else

                                                    <option
                                                        value="minute" {{$edit_data->PackageVehicle->package_period=="minute" ? "selected" : ''}}>
                                                        Minute (s)
                                                    </option>
                                                    <option
                                                        value="hour" {{$edit_data->PackageVehicle->package_period=="hour" ? "selected" : ''}}>
                                                        Hour (s)
                                                    </option>
                                                    <option
                                                        value="day" {{$edit_data->PackageVehicle->package_period=="day" ? "selected" : ''}}>
                                                        Day (s)
                                                    </option>
                                                    <option
                                                        value="week" {{$edit_data->PackageVehicle->package_period=="week" ? "selected" : ''}}>
                                                        Week (s)
                                                    </option>
                                                    <option
                                                        value="month" {{$edit_data->PackageVehicle->package_period=="month" ? "selected" : ''}}>
                                                        Month (s)
                                                    </option>
                                                    <option
                                                        value="year" {{$edit_data->PackageVehicle->package_period=="year" ? "selected" : ''}}>
                                                        Year (s)
                                                    </option>
