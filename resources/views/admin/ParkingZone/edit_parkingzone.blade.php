...
{{--                                             <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6" id="parking_charge">
                                                    <label for="inputCity" class="col-form-label">Charge</label>
                                                    <div class="input-group">
                                                        <input value="{{$edit_data->parking_charge}}" id="data_parking_charge"  name="parking_charge" type="number" class="form-control" placeholder="Charge" readonly>
                                                ...
                                                <div class="form-group col-md-3" id="parking_time">
                                                    <label for="inputCity" class="col-form-label">Time</label>
                                                    <div class="input-group">
                                                        <input value="{{$edit_data->parking_time}}" id="data_parking_time"  name="parking_time" type="number" class="form-control" placeholder="Time" readonly="" >
                                                ...
                                                <div class="form-group col-md-3" id="parking_period">
                                                    ...
                                                    <select id="data_parking_period" name="parking_period" class="form-control" readonly >
                                                        ...
                                                        <option value="minute" {{$edit_data->parking_period=="minute" ? "selected" : ''}}>Minute (s)</option>
                                                        <option value="hour" {{$edit_data->parking_period=="hour" ? "selected" : ''}}>Hour (s)</option>
                                                        <option value="day" {{$edit_data->parking_period=="day" ? "selected" : ''}}>Day (s)</option>
                                                        <option value="week" {{$edit_data->parking_period=="week" ? "selected" : ''}}>Week (s)</option>
                                                        <option value="month" {{$edit_data->parking_period=="month" ? "selected" : ''}}>Month (s)</option>
                                                        <option value="year" {{$edit_data->parking_period=="year" ? "selected" : ''}}>Year (s)</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{$edit_data->parking_limit}}" class="form-control" name="parking_limit" id="parking_limit" placeholder="Parking Limit">
