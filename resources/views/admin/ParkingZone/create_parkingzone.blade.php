                            ...
                            <div class="card card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <form action="{{route('parkingzone.store')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3" id="package_period">
                                                    ...
                                                    <select id="data_package_period" name="package_period" class="form-control" disabled="">
                                            ...
                                            <!-- Vehicle Type Data -->
                                            <div class="form-row">
                                                <div class="form-group col-md-6" id="vehicle_charge">
                                                    <label for="inputCity" class="col-form-label">Charge</label>
                                                    <div class="input-group">
                                                        <input id="data_vehicle_charge"  name="vehicle_charge" type="number" class="form-control" placeholder="Charge" readonly>

                                                    </div>
                                                    <span class="help-block" id="vehicle_time_error" style="color:red;"></span>
                                                </div>

                                                <div class="form-group col-md-3" id="vehicle_time">
                                                    <label for="inputCity" class="col-form-label">Time</label>
                                                    <div class="input-group">
                                                        <input id="data_vehicle_time"  name="vehicle_time" type="number" class="form-control" placeholder="Time" readonly="" >

                                                    </div>
                                                    <span class="help-block" id="vehicle_time_error" style="color:red;"></span>
                                                </div>

                                                <div class="form-group col-md-3" id="vehicle_period">
                                                    <label for="inputState" class="col-form-label">Period</label>
                                                    <select id="data_vehicle_period" name="vehicle_period" class="form-control" disabled >
...
@section('script')
<script async defer src="https://maps.googleapis.com/maps/api/js?key=Your_APi_Key&maptype=roadmap&libraries=places&callback=initMap"></script>
